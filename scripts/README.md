...
5. Lancia — in pochi secondi il fork ha milestone, label e 19 issue pronte
...
Lo script non conta "il terzo commit" a mano: punta a un **tag git** (default: `template-init`), perché contare i commit in modo ordinale è fragile — se in futuro aggiungi anche un solo commit prima di quelli iniziali, "il terzo" smette di essere quello giusto, e qui uno sbaglio del genere significa perdere lavoro, non un bug innocuo.

Dopo aver completato i commit di inizializzazione del progetto, crea il tag una volta sola:
